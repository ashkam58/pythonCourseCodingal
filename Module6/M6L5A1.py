# M6L5A1: Space Invader Game
# Activity 1: Capstone Space Invader Game with Player Movement, Multiple Enemies, Bullet Firing, Distance-Based Collision Detection, Score Display, and Game Over Logic
