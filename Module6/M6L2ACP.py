# M6L2ACP: Mini Sprite Adventure
# After Class Project: Pygame Rectangles, Solid & Outlined Shapes, get_pressed() Arrow Movement, min/max Clamping, and Edge Color Triggers
