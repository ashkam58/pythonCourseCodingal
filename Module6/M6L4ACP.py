# M6L4ACP: Pet Food Collection Game
# After Class Project: Sprite Collision (.colliderect()), Removing Collected Items, Scaled Backgrounds, SysFont(), and Manual Text Centering
