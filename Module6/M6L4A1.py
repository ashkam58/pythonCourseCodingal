# M6L4A1: Sprite collision
# Activity 1: Collision Detection with .colliderect(), Removing Sprites from Groups, Scaled Backgrounds, Named Fonts (SysFont), and Manual Text Centering
