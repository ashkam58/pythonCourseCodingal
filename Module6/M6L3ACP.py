# M6L3ACP: Smart Traffic Signal Simulator
# After Class Project: Custom Car Sprite, Sprite Groups, Boundary Collision Sensors, Custom USEREVENTs, and Traffic Signal Logic
...
while running:
    ...
    for x in range(0, 600, 80):
        pygame.draw.rect(
            screen, WHITE, (x, 345, 45, 5)
        )

    # Draw the traffic-signal box
    pygame.draw.rect(
        screen, pygame.Color("black"), (275, 40, 50, 90)
    )

    # Draw the active traffic-signal light
    pygame.draw.circle(
        screen, signal_color, (300, 85), 20
    )
