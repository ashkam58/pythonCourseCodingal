# M6L1ACP: Wildlife Information Display
# After Class Project: Pygame Setup, Window Display, Loading/Scaling Images, Multi-font Text Rendering, Rect Positioning, and 30 FPS Clock
...
wildlife_image = pygame.transform.scale(
    pygame.image.load("tiger.png").convert_alpha(), (220, 220)
)
...
heading_text = heading_font.render(
    "Wildlife Spotlight: Tiger", True, pygame.Color("black")
)
...
fact_text = fact_font.render(
    "Tigers are powerful wild cats.", True, pygame.Color("black")
)
