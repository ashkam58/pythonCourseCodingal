# Module 7 Lesson 5 ACP: Reading Schedule Planner
# Multi-window planner using Toplevel, floor division, modulo, and try/except validation
...
heading = Label(
    root, text="Reading Schedule Planner", font=("Arial", 18, "bold"), bg="light blue"
)
heading.pack(pady=40)

instruction = Label(
    root, text="Create a simple plan to complete your book.", bg="light blue", font=("Arial", 11)
)
...
def topwin():
    ...
    pages_label = Label(
        top, text="Enter total number of pages:", bg="light grey"
    )
    pages_entry = Entry(top)

    daily_label = Label(
        top, text="Enter pages you can read each day:", bg="light grey"
    )
    daily_entry = Entry(top)

    result_label = Label(
        top, text="Your Reading Plan", font=("Arial", 14, "bold"), bg="light grey"
    )
    days_label = Label(
        top, text="Complete reading days:", bg="light grey"
    )
    remaining_label = Label(
        top, text="Pages remaining:", bg="light grey"
    )
    ...
    def calculate_plan():
        ...
        # PART 5: Handle invalid input
            ...
            messagebox.showerror(
                "Invalid Input", "Please enter valid whole numbers."
            )

    # Add button connected to the nested function
    calculate_button = Button(
        top, text="Create Plan", command=calculate_plan, bg="#1261A0", fg="white"
    )
...
start_button = Button(
    root, text="Create My Reading Plan", command=topwin, bg="#1261A0", fg="white"
)
