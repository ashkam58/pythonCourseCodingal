# M7L1ACP: Workshop Participant Greeting
# After Class Project: Digital Welcome Desk using Tkinter GUI widgets
...
# PART 5: Create the Text widget for multi-line output
text_box = Text(
    height=4,
    width=40
)

# PART 6: Create the button and connect its command (NO parentheses!)
...
# PART 7: Arrange the widgets using pack()
heading.pack()
