# M7L1A2: Getting Started with Widgets
# Activity 2: Interactive GUI with Label, Entry, Text, and Button widgets
...
def display():
    ...
    # Specify where to add the details inside the text box using END
...
# When button is clicked, display function will be called automatically (no parentheses!)
btn = Button(text="Begin", command=display, height=1, bg="#1261A0", fg='white')

# Organize all the widgets in the window using pack()
lbl.pack()
name_lbl.pack()
name_entry.pack()
btn.pack()
